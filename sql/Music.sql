...
insert into Music(id,Artist_name, Genre_type , Albums, Songs,  price) values(5,'Evanescence','Metal','The Open Door','Lithium','10');
insert into Music(id, Artist_name, Genre_type , Albums, Songs,  price) values(6,'Linkin Park','Alternative Metal','Hybrid Theory','Crawling','10');
insert into Music(id,Artist_name, Genre_type , Albums, Songs, price) values(7,'Cuco','Indie','Wannabewithu','Lover is a Day','10');
